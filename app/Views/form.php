            ...
            <div class="card-body" style="padding: 3rem;">
                ...
                <div class="d-block p-5 bg-light">
                    <form action="<?= base_url('store') ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="">Apakah anda siap mengeluarkan dana kemitraan sekitar Rp 25.000.000?  (exclude biaya pengiriman, include booth dan semua bahan baku serta peralatan) </label>
